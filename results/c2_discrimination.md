...
| `assert_math_presence` | ✅ | ✅ | 0.0015 | 0.0023 | thấp hơn nguồn: 0.0015 < opendataloader 0.0023. (Quan trắc, không phải lỗi metric: `pdf_inspector` còn thấp hơn cả bản làm hỏng.) |
| `assert_reading_order` | ✅ | ✅ | 0.0910 | 0.4076 | thấp hơn nguồn: 0.0910 < opendataloader 0.4076. |
| `assert_table_relation` | ✅ | ✅ | 0.0000 | 0.3101 | thấp hơn nguồn: 0.0000 < opendataloader 0.3101. |
| `assert_text_absence` | ✅ | ❌ | 0.7556 | 0.4589 | KHÔNG thấp hơn nguồn: 0.7556 ≥ opendataloader 0.4589 — METRIC NÀY SAI, làm hỏng đầu ra mà điểm không giảm. |
| `assert_text_presence` | ✅ | ✅ | 0.0592 | 0.1301 | thấp hơn nguồn: 0.0592 < opendataloader 0.1301. |
| `cer` | ⬜ | — | — | — | metric không đo được ở đây (sabotage n_scored=0, opendataloader n_scored=0) — cổng KHÔNG chạy, không tính là đạt. |
| `heading` | ✅ | ✅ | 0.0000 | 0.5611 | thấp hơn nguồn: 0.0000 < opendataloader 0.5611. |
| `img_f1` | ✅ | ✅ | 0.1446 | 0.3650 | thấp hơn nguồn: 0.1446 < opendataloader 0.3650. |
| `img_iou` | ✅ | ✅ | 0.0912 | 0.3132 | thấp hơn nguồn: 0.0912 < opendataloader 0.3132. |
...
**9/14** metric có cổng chạy được; **7/9** trong số đó đạt.
...
- **Bảng chính — 5/14**: `assert_math_presence`, `assert_reading_order`, `assert_table_relation`, `img_f1`, `img_iou`
- **Phân tán đủ NHƯNG trượt cổng `sabotage` — 2**: `assert_baseline`, `assert_text_absence`
- **Phụ lục, không phân biệt được — 0**: _trống_
- **Phụ lục, chưa đủ dữ liệu — 7**: `assert_text_presence`, `cer`, `heading`, `nid`, `teds`, `teds_struct`, `wer`
