...
In contrast, there exists a family of simple 3-planar graphs with 5 . 5 n − 15 edges whose standard drawings have 5 . 5 n − 21 crossings (Figure 2). Thus, there is a gap of 1 . 1 n between the lower and the upper bound for the crossing number of 3-plane drawings.

![](<2503.08365_pg2_images/imageFile2.png>)
