...
Finally, a third contribution, as we show in Theorem 4.4, is that the preimage of 0 under ξ  → y ( T, · ; ξ ; y 0 ; u ) is ﬁnite for all y 0 ∈ L 2 ( G ) \ { 0 } and u ∈ L 2 ((0 ,T ) × G 0 ). In particular, the event: “the system (1.1) is simultaneous null controllable” is negligible for absolutely continuous random variables, that is,
