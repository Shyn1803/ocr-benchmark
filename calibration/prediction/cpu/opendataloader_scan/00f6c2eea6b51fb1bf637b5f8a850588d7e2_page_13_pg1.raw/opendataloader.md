...
- [38]   Huang L, Pun CM (2020) Audio replay spoof attack detection by joint segment-based linear filter bank feature extraction and attentionenhanced DenseNet-BiLSTM network. IEEE/ACM Transactions on Audio, Speech, and Language Processing 28: 1813-1825. Hua G, engjinteoh A, Zhang H (2021) Towards end-to-end synthetic


Hua G, Bengjinteoh A, Zhang H (2021) Towards end-to-end synthetic speech detection. IEEE Signal Processing Letters_

[40]   Mittal T, Bhattacharya U, Chandra R, era A, Manocha D (2020, October) Emotions don t lie: an audio-visual deepfake detection method using affective cues. In Proceedings of the 28th A M international conference on multimedia, pp 2823-2832 .

[41]   Chugh K, Gupta P, Dhall A, Subramanian R (2020, October) Not made for each other-audio-visual dissonance-based deepfake detection and localization. In Proceedings of the 28th A M International onference on Multimedia, pp 439-447 .

[42]   Gu Y, Zhao X, Gong C, Yi X (2020, November) Deepfake video detection using audio-visual consistency. In International Workshop on Digital Watermarking, Springer, ham, pp 168-180 .
...
Gino (2021) Audio-video deepfake detection through emotion recognition:

Mozley K (2021) Don't believe everything you hear: combining audio

Blankertz B (2001) The constant Q transform URL http:lldoc. ml_ tu -

[47]   Sch rkhuber , Klapuri A, Sontacchi A (2012, September) Pitch shifting of audio signals using the constant-q transform. In Proc. of the DAFx onference.  
...
- [49]   Wang M, Wang R, Zhang XL, Rahardja S (2019, November) Hybrid constant-Q transform based CNN ensemble for acoustic scene  


classification. In 2019 Asia-pacific signal and information processing association annual summit and conference (APSIPA AS ), pp 15111516 .
...
- [52]   Szegedy , Ioffe S, Vanhoucke V, Alemi AA (2017, February) Inception-v4, inception-resnet and the impact of residual connections on learning. In Thirty-first AAAI conference on artificial intelligence.  
- [53]   Arfianti UI, Novitasari D R, Widodo N, Hafiyusholeh M, Utami WD (2021) Sunspot number prediction using gated recurrent unit (GRU) algorithm. IJ S (Indonesian Journal of omputing and ybernetics Systems) 15(2): 141-152 .   Le XH, Ho HV, Lee G (2019, September) Application of gated recurrent


[54] unit (GRU) network for forecasting river water levels affected by tides. In International onference on Asian and Pacific oasts, Springer, Singapore, pp 673-680 .
