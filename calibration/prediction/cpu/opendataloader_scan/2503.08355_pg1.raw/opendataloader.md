...
where f : R d → R d is the vector ﬁeld governing the system, can we reconstruct f from the observed data ?
...
1 Laboratoire de Math´ematiques d’Orsay, Universit´e Paris-Saclay, Orsay, France 2 DataShape, Inria Saclay, Palaiseau, France
