![](<67bd68f8d9aca21dcafbf3b0cb47ad031f28fe8b58c44672388c6cff0d1cef19_images/imageFile1.png>)

Select Enclosure

The following enclosures will be added to the system. Expansion enclosures that are directly cabled to the new control enclosures are not
...
![](<67bd68f8d9aca21dcafbf3b0cb47ad031f28fe8b58c44672388c6cff0d1cef19_images/imageFile2.png>)
...
Local authentication is performed within the Storwize V7000 system. Local GUI authentication is done with user name and password. Local CLI authentication is done either with an SSH public key or a user name and password.
