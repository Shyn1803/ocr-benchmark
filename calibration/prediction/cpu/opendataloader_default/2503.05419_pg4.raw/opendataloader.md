...
2.1. Model formulation The model is based on the anisotropic damage framework, defined by the following free energy potential
...
λ [tr(ε)]2 + µ tr(ε · ε) + g tr(ε · ω) + α tr(ε) tr(ε · ω) + 2 β tr(ε · ε · ω) , (1)
...
= λ tr(ε)I + 2µε + gω + α tr(ε · ω)I + tr(ε)ω + 2β(ε · ω + ω · ε) . (2)
